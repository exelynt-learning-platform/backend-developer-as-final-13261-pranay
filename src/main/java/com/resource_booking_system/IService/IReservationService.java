...
public interface IReservationService {
    ...
    Page<ReservationResponse> getAllReservation(ReservationStatus reservationStatus,
                                                BigDecimal minPrice,
                                                BigDecimal maxPrice,
                                                String username,
                                                boolean isAdmin,
    ...
    ReservationResponse updateReservation(Long id,
                                          ReservationUpdateRequest reservationUpdateRequest,
                                          boolean isAdmin);

    ReservationResponse updateReservationStatus(Long id,
                                                ReservationStatusUpdateRequest statusUpdateRequest,
                                                boolean isAdmin);
