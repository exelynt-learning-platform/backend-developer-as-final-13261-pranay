...
class ReservationServiceImplTest {
    ...
    void updateReservation_Admin_ShouldUpdateSuccessfully() {
        ...
        ReservationResponse response = reservationService.updateReservation(1L, request, "Pranay", true);
    ...
    void updateReservation_WhenNotFound_ShouldThrowException() {
        ...
        assertThrows(ReservationNotFoundException.class, () -> reservationService.updateReservation(99L, request, "Pranay", true));
    ...
    void updateReservation_WhenStartAfterEnd_ShouldThrowException() {
        ...
        assertThrows(BadRequestException.class, () -> reservationService.updateReservation(1L, request, "Pranay", true));
    ...
    void updateReservation_WhenResourceNotFound_ShouldThrowException() {
        ...
        assertThrows(ResourceNotFoundException.class, () -> reservationService.updateReservation(1L, request, "Pranay", true));
    ...
    void deleteReservation_Admin_ShouldDeleteSuccessfully() {
        ...
        reservationService.deleteReservation(1L, "Pranay", true);
    ...
    void deleteReservation_WhenNotFound_ShouldThrowException() {
        ...
        assertThrows(ReservationNotFoundException.class, () -> reservationService.deleteReservation(99L, "Pranay", true));
